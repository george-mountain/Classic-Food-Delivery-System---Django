...
ALLOWED_HOSTS = ['your live server ip here...','127.0.0.1','engineergeorge.com.ng','www.engineergeorge.com.ng']
...
MIDDLEWARE = [
    ...
    'orders.request_object.RequestObjectMiddleware', # custom middleware to access request obj in models.py  
]
...
STATICFILES_DIRS = [
    'foodOnline_main/static'    #path to the static file.
]
...
MESSAGE_TAGS = {
    messages.ERROR: 'danger', #danger for the bootstrap class
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'foodOnline Marketplace <sample_email@gmail.com>'
