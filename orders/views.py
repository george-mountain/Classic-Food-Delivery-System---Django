...
def payments(request):
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest' and request.method == 'POST':
        ...
        # retrieve ordered food to be passed to the order confirmation email page
        ordered_food = OrderedFood.objects.filter(order=order)

        # calc subtotal, tax data and total for the ordered food
        customer_subtotal = 0
        ...
        context = {
            ...
            'domain': get_current_site(request), #import from django.contrib.sites.shortcuts
        ...
        for i in cart_items:
            if i.fooditem.vendor.user.email not in to_emails:
                ...
                context = {
                    ...
                    'user': i.fooditem.vendor.user.first_name,
                    'order': order,
